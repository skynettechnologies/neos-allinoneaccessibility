# All in One Accessibility®:Neos CMS Plugin
...
You can install the All in One Accessibility package using Composer:
1. Open your terminal and navigate to the root of your Neos project.
   
2. Run the following command:

``` bash
composer require skynettechnologies/neos-allinoneaccessibility
```
...
## Configuration
To configure the widget, go to Administration -> All in One Accessibility®.
